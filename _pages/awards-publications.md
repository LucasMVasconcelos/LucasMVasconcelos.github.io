---
permalink: /awards-publications/
title: "Awards and Publications"
excerpt: "Academic publications and awards, from robotics research to my master's dissertation."
toc: true
---
...
### Utilização do eletro-oculograma para diminuir o sinal de ruído na medição de EEG
*VII Simpósio de Iniciação Científica, Didática e de Ações Sociais da FEI — October 2017*
...
### PRAD (Programa de Reconhecimento de Alto Desempenho)
*January 2020*

Awarded for deliverables and projects completed in 2019.

### INOVA FEI
*Centro Universitário FEI — June 2018*

Award from Centro Universitário FEI recognizing the best undergraduate capstone projects (TCC) among the engineering programs.

### Brazilian and Latin American Robotics Competition — 1st Place, @Home category
*October 2016*

Developed a robot capable of recognizing a user, following a person, recognizing objects, and navigating the environment, using ROS as the control platform.
